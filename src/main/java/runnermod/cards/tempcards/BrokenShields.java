...
public class BrokenShields extends BaseCard {
    public static final String ID = makeID(BrokenShields.class.getSimpleName());
...
//    //Card Stats
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToTop(new ChangeRunnerStanceAction("Shields",magicNumber));
    }
}
