...
public class BackwardsHexFloatParticle extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public BackwardsHexFloatParticle() {
        ...
        this.x = AbstractDungeon.player.hb.cX + MathUtils.random(100.0F, 160.0F) * Settings.scale - 128.0F;
        this.y = AbstractDungeon.player.hb.cY + MathUtils.random(-50.0F, 220.0F) * Settings.scale - 128.0F;
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x, this.y, 32.0F, 16.0F, 96.0F, 96f, this.scale, this.scale + (this.dur_div2 * 0.4F - this.duration) * Settings.scale, this.rotation, 0, 0, 64, 64, false, false);
